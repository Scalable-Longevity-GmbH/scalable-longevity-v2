...
import ProfileBodyStep from "./steps/ProfileBodyStep";
import ActivityStep from "./steps/ActivityStep";
import CardioStep from "./steps/CardioStep";
import MetabolicDiabetesStep from "./steps/MetabolicDiabetesStep";
import MetabolicLipidsStep from "./steps/MetabolicLipidsStep";
import ResultsPreview from "./components/ResultsPreview";
import DataSharingStep from "./steps/DataSharingStep";
import LifestyleMindsetStep from "./steps/LifestyleMindsetStep";
import LifestyleNutritionStep from "./steps/LifestyleNutritionStep";
import SurveyEntryTracker from "./components/SurveyEntryTracker";
...
export default function SurveyPage() {
  ...
  return (
    <section id="survey" className="h-screen w-full flex flex-col items-center">
      ...
      <Link
        href="/"
        className="absolute top-6 left-6 md:top-8 md:left-8 text-primary z-10"
